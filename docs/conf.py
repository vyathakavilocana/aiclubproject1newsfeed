# -*- coding: utf-8 -*-
#
# AIClubProject1NewsFeed documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'AIClubProject1NewsFeed'
...
htmlhelp_basename = 'aiclubproject1newsfeeddoc'
...
latex_documents = [
    ('index',
     'aiclubproject1newsfeed.tex',
     u'AIClubProject1NewsFeed Documentation',
     u"Pratham Chhabria", 'manual'),
]
...
man_pages = [
    ('index', 'aiclubproject1newsfeed', u'AIClubProject1NewsFeed Documentation',
     [u"Pratham Chhabria"], 1)
]
...
texinfo_documents = [
    ('index', 'aiclubproject1newsfeed', u'AIClubProject1NewsFeed Documentation',
     u"Pratham Chhabria", 'AIClubProject1NewsFeed',
